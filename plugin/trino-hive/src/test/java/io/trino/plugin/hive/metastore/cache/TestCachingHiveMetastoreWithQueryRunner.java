        ...
        extends AbstractTestQueryFramework
{
            ...
            throws Exception
    {
        ...
        rawMetastore = ((HiveConnector) queryRunner.getCoordinator().getConnector(CATALOG)).getInjector()
                .getInstance(Key.get(HiveMetastoreFactory.class, RawHiveMetastoreFactory.class))
